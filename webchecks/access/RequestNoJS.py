...
from webchecks.utils.messaging import logging, log_link, logging_push_where, logging_pop_where
...
class RequestNoJS(object):
    ...
    def request_resource(self, linkpair) -> Tuple[bytes, dict, str]:
        ...
        ------------
        linkpair : URLPair
            A linkpair object containing the URL to request and the URL originally entered by the user.
            Remember they may be different as the Gateway may have needed to add the protocol.
        """
        link = linkpair.url
